...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        if(movedPiece instanceof Pawn){
            if(movedPiece.getColor() == Color.WHITE && target.getRow() == 0 || movedPiece.getColor() == Color.BLACK && target.getRow() == 7){
                promoted = movedPiece = (ChessPiece)board.piece(target);
    ...
    private ChessPiece newPiece(String type, Color color){
        ...
        else if (type.equals("B")){ return new Bishop(board, color);}
    ...
    private Piece makeMove(Position source, Position target){
        ...
        // #special move castling kinside rook
    ...
    private void validateSourcePosition(Position position){
        if(!board.theresIsAPiece(position)){
            throw new BoardException("Theres no piece on source position");
        }
